...
export class Menus {
  ...
  _menuItems() {
    ...
    if (this.menuPage === 'settings') {
      ...
      return [
        ...
        { id: 'autoQuality', label: 'Adaptive resolution', value: s.get('autoQuality') ? 'On' : 'Off', toggle: true },
  ...
  _renderDetail(item) {
    ...
    const help = {
      ...
      autoQuality: 'Scales render resolution automatically to hold your target frame rate.',
